...
public class Drivetrain {
  ...
  private final SwerveModule m_frontLeft = new SwerveModule(Constants.frontRightDriveID, Constants.frontRightTurnID);
  private final SwerveModule m_frontRight = new SwerveModule(Constants.frontLeftDriveID, Constants.frontLeftTurnID);
  private final SwerveModule m_backLeft = new SwerveModule(Constants.backRightDriveID, Constants.backRightTurnID);
  private final SwerveModule m_backRight = new SwerveModule(Constants.backLeftDriveID, Constants.backLeftTurnID);
